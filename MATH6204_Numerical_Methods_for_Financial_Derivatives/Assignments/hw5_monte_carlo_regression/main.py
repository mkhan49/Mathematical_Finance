...
from monte_carlo_regression import *
...
if __name__ == '__main__':
    print('\nMonte Carlo Regression method II values of American Call\n')
    print('Time step', ' MC_value')
    monte_carlo_reg2(100,100,0.03,0.025,0.75,1,0.01,1)
    monte_carlo_reg2(100,100,0.03,0.025,0.75,1,0.001,1)
    
    print('\nMonte Carlo Regression method II values of American Put\n')
    print('Time step', ' MC_value')
    monte_carlo_reg2(100,100,0.03,0.025,0.75,1,0.01,0) 
    monte_carlo_reg2(100,100,0.03,0.025,0.75,1,0.001,0)
